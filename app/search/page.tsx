  ...
  return (
    <div className="w-full">
      ...
      <section className="sticky top-14 z-20 border-b border-rule bg-paper">
        ...
        <div className="flex w-full items-center gap-3 px-6 py-2 pt-6 lg:px-10">
          <div className="relative flex-1">
            <input
              value={q}
              onChange={(e) => setQ(e.target.value)}
              placeholder="Search title, summary, instrument…"
              className="w-full rounded-full border border-ink/20 bg-paper px-5 py-3 pr-10 text-sm placeholder:text-ink/40 focus:border-ocean focus:outline-none focus:ring-2 focus:ring-ocean/20"
            />
